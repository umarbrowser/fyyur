"""Added updates on table and columns

Revision ID: 5c488e965342
Revises: 
Create Date: 2022-06-01 16:51:48.134368
...
def upgrade():
    ...
    sa.Column('seeking_description', sa.String(length=30), nullable=True),
